  ...
  const rule = {
    ...
    address: Joi.string()
      ...
      .messages({
        "string.empty": "the field is required",
        "string.pattern.base":
          "only allows alphanumeric i.e. a-Z, 0-9 and commas",
        "string.max":
          "length must be less than or equal to {{#limit}} characters long",
      }),
    ...
    organization: Joi.string()
      ...
      .messages({
        "string.empty": "the field is required",
        "string.pattern.base": "only allows alphanumeric i.e. a-Z and 0-9",
        "string.max":
          "length must be less than or equal to {{#limit}} characters long",
      }),
  };
...
export default validUpdateContact;
